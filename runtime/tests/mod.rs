...
//   xx xx xx 01                                                                (0 .. 2**6)         (u8)
//   yL yL yL 01 / yH yH yH yL                                                  (2**6 .. 2**14)     (u8, u16)   low LH high
//   zL zL zL 10 / zM zM zM zL / zM zM zM zM / zH zH zH zH                      (2**14 .. 2**30)    (u16, u32)  low LMMH high
...
fn test_compact() {
    ...
    assert_encode(Compact(1u64), &[0b00001000]);
    ...
    // 16383
    assert_encode(Compact((1u64 << 14) - 1), &[0b1111101, 0b11111111]);
    assert_encode(Compact((1u64 << 14) - 1), &[0b1111101, 0b11111111]);
